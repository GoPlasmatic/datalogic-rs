...
- **59 built-in operators** with full JSONLogic spec compliance — 57 in the default build plus 2 opt-in [OpenFeature flagd-compatible](https://flagd.dev/reference/custom-operations/) operators (`fractional`, `sem_ver`) behind `features = ["flagd"]`
