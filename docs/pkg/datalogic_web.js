...
export class JsJsonLogic {
    ...
    apply(rules, data) {
        ...
        const ret = wasm.jsjsonlogic_apply(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    reset() {
        wasm.jsjsonlogic_reset(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('datalogic_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
