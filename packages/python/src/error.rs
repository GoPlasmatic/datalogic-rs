...
create_exception!(datalogic, DataLogicError, PyException, "Base exception raised by datalogic.");
create_exception!(datalogic, ParseError, DataLogicError, "Raised when a rule or data input cannot be parsed.");
create_exception!(
    datalogic,
    EvaluateError,
    DataLogicError,
