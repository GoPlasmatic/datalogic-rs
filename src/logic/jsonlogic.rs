...
use crate::logic::{evaluate, IntoLogic, Logic};
...
// Implement FromStr for JsonLogic
impl FromStr for JsonLogic {
    type Err = LogicError;

    fn from_str(json_str: &str) -> Result<Self> {
        let json: serde_json::Value =
            serde_json::from_str(json_str).map_err(|e| LogicError::ParseError {
