...
/// DatetimeOperator - creates or parses a datetime
...
/// TimestampOperator - creates or parses a duration
...
/// ParseDateOperator - parses a date string with a format
pub struct ParseDateOperator;

impl Operator for ParseDateOperator {
    fn evaluate(
        &self,
        args: &[Value],
        context: &mut ContextStack,
...
/// FormatDateOperator - formats a datetime with a format string
pub struct FormatDateOperator;

impl Operator for FormatDateOperator {
    fn evaluate(
        &self,
        args: &[Value],
        context: &mut ContextStack,
...
/// DateDiffOperator - calculates difference between two dates
