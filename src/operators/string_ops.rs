...
/// UpperOperator - converts a string to uppercase
...
/// LowerOperator - converts a string to lowercase
...
/// TrimOperator - removes leading and trailing whitespace from a string
pub struct TrimOperator;

impl Operator for TrimOperator {
    fn evaluate(
        &self,
        args: &[Value],
        context: &mut ContextStack,
...
/// SplitOperator - splits a string by delimiter or extracts regex groups
